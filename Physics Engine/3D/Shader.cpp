...
#define UNIFORMERROR std::string msg = "Vectors cant be "; if(vectorSize > 4){msg += "greater than 4.";} else if(vectorSize < 1){msg += "less than 1.";}std::cout << (msg, __FILE__, __LINE__);
